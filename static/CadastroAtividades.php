                ...
                <div class="container-fluid p-0">
                        ...
                        if ($acao != "") {
                            ...
                            try {
                                    ...
                                    echo "<script>
                                        ...
                                        print 'Erro ao Inserir Atividade <br>' . $e . '<br>';
                                    }
                                }
                        }
                    }
                    ...
                    <div class="col-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="CadastroAtividades.php" method='post'>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="Nome" class="form-label">Descrição Atividade</label>
                                        <input type="text" class="form-control" id="desc_Atividade"
                                            name='desc_Atividade' required autocomplete="off">
                                    </div>
                                    <div class="mb-3">
                                        <label for="Nome" class="form-label">Valor Total Mensal</label>
                                        <input type="text" class="form-control" id="vlr_total_Atividade"
                                            name='vlr_total_Atividade' required autocomplete="off">
                                    </div>
                                    <div class="mb-3">
                                        <label for="Nome" class="form-label">Valor Mensal</label>
