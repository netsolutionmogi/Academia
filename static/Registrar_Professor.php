            ...
            <div class="d-flex mx-auto align-items-center justify-content-center">
                ...
                <div class="card">
                    ...
                    <div class="card-body" style='margin-top:20px; padding: 20px;'>
                        <h5 class="card-title mb-3">Registrar Professor:</h5>
                        <form action="Registrar_Professor.php" enctype='multipart/form-data' method='post'
                            id="login-form">
                            <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <input type="text" class="form-control" id="data_nasc_Instrutor"
                                        name='data_nasc_Instrutor' maxlength="8" required placeholder="Data Nascimento"
                                        autocomplete="off">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name='tel_instrutor' id="tel_instrutor"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3 col-sm-3 col-md-3 col-lg-3">
                                    ...
                                    <input type="text" class="form-control" id="num_instrutor" name='num_instrutor'
                                        maxlength="12" required autocomplete="off">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="compl_Instrutor" name='compl_Instrutor'
                                        maxlength="12" required autocomplete="off">
                                </div>
