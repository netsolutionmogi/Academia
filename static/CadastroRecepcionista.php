                    ...
                    <div class="col-8">
                        <div class="card">
                            <div class="card-header">
                                <h5>Cadastro de Recepcionistas</h5>
                            </div>
                            <div class="card-body">
                                <form action="CadastroRecepcionista.php" enctype='multipart/form-data' method='post'>
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="email_Recepcionista" required
                                            placeholder="E-mail">
