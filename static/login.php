                ...
                <div class="card-body mt-5" style='margin-top: -50px; padding: 20px;'>
                    <form action="login.php" method="post" id="login-form">
                        <div class="input-group mb-3">
                            <select class="form-select form-select-lg mb-3" id="dynamic_select"
                                aria-label=".form-select-lg example" name="select">
                                <option selected value="">Selecione</option>
                                <option value="loginAluno.php">Aluno</option>
                                <option value="loginProfessor.php">Professor</option>
                                <option value="loginRecepcionista.php">Recepcionista</option>
                            </select>
                        </div>
                    ...
                    <hr>
                    <center>
                        <p>Escolha sua opção para Logar no sistema</p>
