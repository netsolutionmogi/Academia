                    ...
                    <div class="col-8">
                        <div class="card">
                            <div class="card-header">
                                <h5>Alterando Personal Trainer</h5>
                            </div>
                            <div class="card-body">
                                <?php
                                ...
                                $id_Aluno = (isset($_POST["id_Aluno"])) ? $_POST["id_Aluno"] : ((isset($_GET["id_Aluno"])) ? $_GET["id_Aluno"] : 0 );
                                $alunoController =  new ALunosController();
                                $aluno = $alunoController->BuscarAlunoPorCodigo();
                                 
                                ?>
                                <form action="AlterandoAlunos.php?id_Aluno=<?php echo $aluno->getid_Aluno();?>"
                                    enctype='multipart/form-data' method='post'>
                                    <div class="mb-2">
                                        <label for="id_Aluno" class="form-label">Id Aluno: </label>
                                        <input type="text" class="form-control" name="id_Aluno"
                                            value="<?php echo $aluno->getid_Aluno();?>" required readonly>

                                    </div>
                                    <div class="mb-2">
                                        <label for="login" class="form-label">Login do Aluno: </label>
                                        <input type="text" class="form-control" name="login"
                                            value="<?php echo $aluno->getLoginAluno();?>" required placeholder="login">

                                    </div>
                                    <div class="input-group mb-3">
                                        <input type="password" class="form-control" name="senha" id="senha" required
                                            value="<?php echo $aluno->getSenhaAluno();?>" placeholder="Senha">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nm_Aluno" required
                                            value="<?php echo $aluno->getnmAluno();?>" placeholder="Nome do Aluno">

                                    </div>
                                    <div class="mb-3">
                                        <label for="sobrenome" class="form-label">Sobrenome: </label>
                                        <input type="text" class="form-control" name="sbnm_Aluno" required
                                            value="<?php echo $aluno->getsbnmAluno();?>"
                                            placeholder="Sobrenome do Aluno">

                                    </div>
                                    <div class="row">
                                        <div class="col-3">
                                            <?php $data = data($aluno->getdata_nasc_aluno());?>
                                            <label for="data_nasc" class="form-label">Data Nasc: </label>
                                            <input type="text" class="form-control" id="data_nasc_Aluno"
                                                name='data_nasc_Aluno' value="<?php echo $data;?>" maxlength="14"
                                                required placeholder="Data Nascimento">
                                        </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="sexo"
                                                        value="Masculino"
                                                        <?php echo $aluno->getsexo() == 'M' ? 'checked="true"' : ''; ?>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="sexo"
                                                        value="Feminino"
                                                        <?php echo $aluno->getsexo() == 'F' ? 'checked="true"' : ''; ?>
                                    ...
                                    <div class="row">
                                        <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                                            ...
                                            <input type="text" class="form-control" id="rg" name='rg' maxlength="8"
                                                value="<?php echo $aluno->getrg_Aluno();?>" required autocomplete="off">
                                        </div>
                                        <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                                            <div class="mb-3">
                                                <label for="Telefone" class="form-label">Telefone</label>
                                                <input type="text" class="form-control" name='tel_aluno' id="tel_aluno"
                                                    value="<?php echo $aluno->gettel_Aluno();?>" required
                                                    autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="email_aluno" required
                                            value="<?php echo $aluno->getemail_Aluno();?>"
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                                            <img id="preview-image"
                                                src="./upload/image/<?php echo $aluno->getfoto_Aluno();?>"
                                                style="width: 220px; height: 150px;"><br><br>
                                        </div>
                                    </div>
